...
def run():
    ...
    for r in cur:
        ...
        drafts.append({'review_id':r['review_id'],'review_date':r['review_date'],'rating':r['rating'],'review':r['review'],'primary_category':primary,'review_reply_url':r['review_reply_url'] or '','draft_response':f"Thank you for sharing your feedback. We're sorry your experience with {primary.lower()} did not meet expectations. We appreciate you bringing this to our attention and will review it with our team. We hope you'll give us another opportunity to provide a better experience."})
