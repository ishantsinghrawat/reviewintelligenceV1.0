...
def run():
    ...
    for r in raw:
        ...
        enriched.append({**r,'review_id':review_id(r),'rating':rating,'sentiment':sentiment_from_rating(rating),'primary_category':aspects[0]['category'],'aspects':aspects,'menu_items':find_menu(r.get('review',''),tax['menu_items'])})
    ...
    for r in cur:
        ...
        drafts.append({'review_id':r['review_id'],'review_date':r['review_date'],'rating':r['rating'],'review':r['review'],'primary_category':primary,'draft_response':f"Thank you for sharing your feedback. We're sorry your experience with {primary.lower()} did not meet expectations. We appreciate you bringing this to our attention and will review it with our team. We hope you'll give us another opportunity to provide a better experience."})
